  ...
  extends ApplicationFrame
{
  ...
  private static JFreeChart createChart()
  {
    ...
    JFreeChart localJFreeChart = ChartFactory.createXYLineChart("Annotation Demo 2", "Date", "Price Per Unit", localXYDataset);
    ...
    localCompositeTitle.setBackgroundPaint(Color.LIGHT_GRAY);
 ...
 * Qualified Name:     demo.AnnotationDemo2
