...
public class AreaChart3D1
{
  ...
  {
    Chart3D localChart3D = Chart3DFactory.createAreaChart("Reported Revenues By Quarter", "Large companies in the IT industry", paramCategoryDataset3D, "Company", "Quarter", "Value");
 ...
 * Qualified Name:     demo.orsoncharts.AreaChart3D1
